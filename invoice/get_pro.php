...
if($_POST['ino']!=null)
{
    ...
    $data=$_POST;
    $sql = "INSERT INTO `invoice` (`bill_id`, `data`) VALUES ( '".$data['ino']."', '".json_encode($data)."')";

$conn->query($sql);

}else
{
     $sql = "SELECT * FROM invoice where bill_id='".$_GET['id']."'";
  ...
  <table class="w3-table w3-bordered" >
    <tr>
      <td colspan="3"style="text-align:right;"><h4>
              <h3>  <b>Proforma Invoice <?php echo $data['ino'];?></b></h3><br/>
