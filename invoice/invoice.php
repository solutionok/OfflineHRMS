...
<div class="w3-container " style=""width="50%">
  <center>  <form class="form-group w3-gray" action="get_pro_1.php" method="post" >
        <br/><lable>Enter Invoice Number</lable>
       ...
       <lable>P.O. NUMBER </lable>
        ...
        <input type="number" name="pno" style="width:300px"required  class="w3-input">
        <br/>
          </div><div class="col-lg-6">
